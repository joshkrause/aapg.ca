            ...
            <div class="container">
               ...
               <div class="row">
                  <div class="col-sm-4 ">
                     ...
                     <a href="{{asset('/storage/conference/2019/2019-aapg-conference-schedule.pdf')}}" class="but mt-30 "  title="Download Program"> Download Program</a>
                  ...
                  <div class="col-sm-8 ">
                     ...
                     <div class="col-sm-4">
                        <ul class="block-tickets ">
                            <li>
                                <ul class="block-ticket">
                                    <li class="block-price"><span class="price"><span class="cur">$</span>350</span><span class="block-type">Non-Member Single Ticket</span></li>
                                    <li>Full Conference Access</li>
                                    <li>Gala Dinner</li>
                                    <li>All Sessions</li>
                                    {{-- <li><a href="#register-modal" class="but mt-30"> Buy Tickets Now</a></li> --}}
