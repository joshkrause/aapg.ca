...
@section('title', 'Informational Items')
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 text-center">
                    <h2 class="title">Informational Items</h2>
                </div>
            </div>
            <!-- Row  -->
            <div class="row wrap-feature-20">
                <!-- Column -->
                @foreach($information as $sample)
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="card-body d-flex no-block">
                                    <div>
                                        <h5 class="font-medium">{{$sample->name}}</h5></div>
                                </div>
                            </div>
                            <div class="col-md-4 text-center">
                                <a href="{{asset('storage/files/resources/' . $sample->file) }}" class="text-white linking bg-success-gradiant">Download <i class="ti-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
