...
@section('title', 'Create Board Members')
...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Create Board Member</h1>
            </div>
            <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0">
                            ...
                            <form action="/admin/board" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group form-group">
                                                ...
                                                <input name="community" type="text" class="form-control" placeholder="Community" value="{{old('community')}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="input-group form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group form-group">
                                                ...
                                                <input name="sort" type="text" class="form-control" placeholder="Sort Order" value="{{old('sort')}}" aria-describedby="sortHelp">
                                            </div>
