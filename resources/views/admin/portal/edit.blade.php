...
@section('title', 'Edit Board Document')
...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Edit Board Document</h1>
            </div>
            <div class="col-sm-6">
                ...
                <li class="breadcrumb-item active">Edit Board Document</li>
                </ol>
            </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Edit Board Document</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body table-responsive p-0">
                            @include('admin.partials.forms.errors')
                            <form action="/admin/portal/{{$resource->id}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('patch')
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <input name="meeting" type="text" class="form-control" placeholder="Meeting (YYYY-MM-DD)" value="{{old('meeting', $resource->meeting)}}">
                                            </div>
                                        </div>
