...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="/admin/nav-buttons">nav-buttons</a></li>
@stop
                        ...
                        <table class="table table-hover">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $nav_button->parent->name ?? 'NONE' }}</td>
...
@section('js')
    <script src="/admin_assets/plugins/nestable/jquery.nestable.js"></script>
