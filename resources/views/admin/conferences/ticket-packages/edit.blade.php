...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark">Edit Ticket Package</h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					...
					<li class="breadcrumb-item active">Edit Ticket Package</li>
				</ol>
			</div>
		</div>
	</div>
			...
			<div class="col-12">
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">Edit Ticket Package</h3>
					</div>
					<!-- /.card-header -->
					<div class="card-body table-responsive p-0">
						@include('admin.partials.forms.errors')
						<form action="/admin/conferences/{{$conference->id}}/ticket-packages/{{$package->id}}" method="post"
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input name="early_bird_price" type="text" class="form-control"
												placeholder="0.00" value="{{old('early_bird_price', $package->early_bird_price / 100)}}">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input name="price" type="text" class="form-control" placeholder="0.00"
												value="{{old('price', $package->price / 100)}}">
										</div>
									</div>
								</div>
								<div class="form-row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input name="member_tickets" type="text" class="form-control"
												placeholder="ie) 4" value="{{old('member_tickets', $package->member_tickets)}}">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<label>Number of Non-Member Tickets</label>
											<input name="non_member_tickets" type="text" class="form-control"
												placeholder="ie) 4" value="{{old('non_member_tickets', $package->non_member_tickets)}}">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
							...
							<div class="modal-footer">
								<a href="/admin/conferences/{{$conference->id}}/ticket-packages"
