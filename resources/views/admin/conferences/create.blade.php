									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input name="early_bird_registration_start" type="text"
												class="form-control datetimepick" placeholder="Select Date and Time"
												value="{{old('early_bird_registration_start')}}">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input name="early_bird_registration_end" type="text"
												class="form-control datetimepick" placeholder="Select Date and Time"
												value="{{old('early_bird_registration_end')}}">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input name="early_bird_member_ticket_price" type="text"
												...
												value="{{old('early_bird_member_ticket_price')}}">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input name="regular_member_ticket_price" type="text" class="form-control"
												placeholder="0.00"
												value="{{old('regular_member_ticket_price')}}">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input name="early_bird_guest_ticket_price" type="text" class="form-control"
												placeholder="0.00"
												value="{{old('early_bird_guest_ticket_price')}}">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input name="regular_guest_ticket_price" type="text" class="form-control"
												placeholder="0.00"
												value="{{old('regular_guest_ticket_price')}}">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											...
											<select name="meal_selection_required" class="form-control">
												<option @if(old('meal_selection_required')=="1") selected="selected"
													@endif value="1">Meal Selection Required</option>
												<option @if(old('meal_selection_required')=="0") selected="selected"
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<select name="active" class="form-control">
												<option @if(old('active')=="0") selected="selected"
													@endif value="0">Draft</option>
												<option @if(old('active')=="1") selected="selected"
