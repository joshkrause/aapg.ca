									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input name="speaker" type="text" class="form-control"
												placeholder="Event Speaker" value="{{old('speaker', $event->speaker)}}">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
									...
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input name="sponsor" type="text" class="form-control"
												placeholder="Event Sponsor" value="{{old('sponsor', $event->sponsor)}}">
										</div>
									</div>
								</div>
								<div class="form-row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input name="start" type="text" class="form-control datetimepick"
												placeholder="Select Date and Time" value="{{old('start', $event->start)}}">
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<label>Event End</label>
											<input name="end" type="text" class="form-control datetimepick"
												placeholder="Select Date and Time" value="{{old('end', $event->end)}}">
										</div>
									</div>
								</div>
							</div>
							<div class="modal-footer">
								<a href="/admin/conferences/{{$conference->id}}/schedule"
