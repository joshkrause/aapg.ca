        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <p class="p-t-10">Supporting excellence in civilian governance and oversight of police services in Alberta</p>
                ...
                <div class="col-lg-3 col-md-6 info-box">
                    ...
                    <div class="d-flex no-block">
                        ...
                        <div class="info">
                            <span class="font-medium text-muted db  m-t-5">(587) 892-7874</span>
                        </div>
                    </div>
                    <div class="d-flex no-block">
