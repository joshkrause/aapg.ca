    ...
    'snippets': [
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/oleg-laptev-545268-unsplash-VD7ll2.jpg">' +
					'</div>' +
				'</div>'
		},
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/jon-lalin-731093-unsplash-(1)-tdmMt1.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
					'</div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/adam-birkett-209727-unsplash-(2)-H2BMm1.jpg">' +
					'</div>' +
				'</div>'
		},
		{
			    ...
			    '<div class="row clearfix">' +
                    '<div class="column full" data-noedit data-module="slider" data-module-desc="Slider" data-html="' +
                        ...
                        encodeURIComponent('<div id="{id}" class="slider-on-content" style="width:100%;height:500px;display:none">' +
                            '<div class="is-boxes slider-image" style="background-image: url(\'/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/slide1.jpg\');">' +
                            '</div>' +
                            '<div class="is-boxes slider-image" style="background-image: url(\'/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/slide2.jpg\');">' +
                            '</div>' +
                            '<div class="is-boxes slider-image" style="background-image: url(\'/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/slide3.jpg\');">' +
                            '</div>' +
                        '</div>' +
                        '' +
                        '<scr' + 'ipt>' +
                        ...
                        encodeURIComponent('[' +
                                '{' +
                                    ...
                                    '"images":' +
                                        '[' +
                                            '{' +
                                                '"src": "/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/slide1.jpg", ' +
                                                '"caption": "", "link": "", "width": "450", "align": "", "position": "bottom left"' +
                                            '},' +
                                            '{' +
                                                '"src": "/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/slide2.jpg", ' +
                                                '"caption": "", "link": "", "width": "450", "align": "", "position": "bottom left"' +
                                            '},' +
                                            '{' +
                                                '"src": "/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/slide3.jpg", ' +
                                                '"caption": "", "link": "", "width": "450", "align": "", "position": "bottom left"' +
                                            '}' +
                                        ']' +
                                '}]') + '"' +
		...
		'html':
				'<div class="row clearfix">' +
                    '<div class="column half">' +
                        '<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/jon-lalin-731093-unsplash-(1)-tdmMt1.jpg" style="margin: 0;float: left;">' +
                    '</div>' +
                    '<div class="column half">' +
                        '<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/adam-birkett-209727-unsplash-(2)-H2BMm1.jpg" style="margin: 0;float: left;">' +
                    '</div>' +
                '</div>'
},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
                    '<div class="column third">' +
                        '<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/chuttersnap-413002-unsplash-83HqE1.jpg" style="margin: 0;float: left;">' +
                    '</div>' +
                    '<div class="column third">' +
                        '<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/caroline-bertolini-270870-unsplash-1j5FB2.jpg" style="margin: 0;float: left;">' +
                    '</div>' +
                    '<div class="column third">' +
                        '<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/theo-roland-740436-unsplash-WqnWJ3.jpg" style="margin: 0;float: left;">' +
                    '</div>' +
                '</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
                    '<div class="column full">' +
                        '<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/oleg-laptev-545268-unsplash-VD7ll2.jpg" style="margin: 0;float: left;">' +
                    '</div>' +
                '</div>'
		},
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/pawel-czerwinski-1080345-unsplash-Zxz1W1.jpg">' +
						'\n<h3 class="size-21">IMAGE CAPTION</h3>' +
						'\n<p>Lorem Ipsum is simply dummy text</p>' +
					'</div>' +
					'<div class="column half center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/agata-create-1137058-unsplash-(1)-UvBs02.jpg">' +
						'\n<h3 class="size-21">IMAGE CAPTION</h3>' +
						'\n<p>Lorem Ipsum is simply dummy text</p>' +
					'</div>' +
				'</div>'
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/monika-grabkowska-742426-unsplash-AtCtH1.jpg">' +
						'\n<h3 class="size-18">CAPTION</h3>' +
						'\n<p class="size-14" style="color: rgb(136, 136, 136);">Lorem Ipsum is dummy text.</p>' +
					'</div>' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/mira-bozhko-456995-YiVKC1.jpg">' +
						'\n<h3 class="size-18">CAPTION</h3>' +
						'\n<p class="size-14" style="color: rgb(136, 136, 136);">Lorem Ipsum is dummy text.</p>' +
					'</div>' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/lauren-mancke-63448-unsplash-AtCtH2.jpg">' +
						'\n<h3 class="size-18">CAPTION</h3>' +
						'\n<p class="size-14" style="color: rgb(136, 136, 136);">Lorem Ipsum is dummy text.</p>' +
					'</div>' +
				'</div>'
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/susanne-schwarz-1142929-unsplash-IZGK11.jpg">' +
						'\n<h3 class="size-21">IMAGE CAPTION</h3>' +
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/art-materials-close-up-color-pencils-1484263-jT5E21.jpg" style="border-radius: 500px;">' +
						'\n<p class="size-14">Lorem Ipsum is dummy text</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/oleg-laptev-546607-unsplash-SKGb82.jpg" style="border-radius: 500px;">' +
						'\n<p class="size-14">Lorem Ipsum is dummy text</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/michal-grosicki-XG2yA3.jpg" style="border-radius: 500px;">' +
						'\n<p class="size-14">Lorem Ipsum is dummy text</p>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/remi-muller-359340-unsplash-JOL3q1.jpg">' +
						'\n<p><i>Lorem Ipsum is dummy text</i></p>' +
					'</div>' +
					'<div class="column half center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/dlanor-s-591314-unsplash-maNC32.jpg">' +
						'\n<p><i>Lorem Ipsum is dummy text</i></p>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/agata-create-1132088-unsplash-(1)-adQTO1.jpg">' +
						'\n<p>IMAGE CAPTION</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/lucrezia-carnelos-1127196-unsplash-Y7ahO2.jpg">' +
						'\n<p>IMAGE CAPTION</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/bright-bulb-close-up-1166643-oof1G3.jpg">' +
						'\n<p>IMAGE CAPTION</p>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/omar-lopez-32084-8ciiC1.jpg">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-ORebV1.jpg">' +
					'</div>' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/ian-dooley-298771-unsplash-Hu2RU3.jpg">' +
					'</div>' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/daniel-klopper-1142809-unsplash-pToHm2.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/anthony-tran-1076077-vcoLP1.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column two-third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/rawpixel-1200191-unsplash-Ms1O81.jpg">' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column two-third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/iman-soleimany-zadeh-1205567-unsplash-AUqMZ2.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/maksym-zakharyak-688728-unsplash-p9w092.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="spacer height-40"></div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/rodion-kutsaev-24833-unsplash-HEuVp1.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column two-third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/monica-galentino-102655-unsplash-gfbdC1.jpg">' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column two-third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/rawpixel-1197453-unsplash-a7ozj2.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-XstZ21.jpg">' +
						'\n<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-budQW2.jpg">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/sarah-dorweiler-211779-unsplash-dN96G1.jpg">' +
						'\n<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/kris-atomic-39874-unsplash-vpMhe2.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/rawpixel-1197458-unsplash-J52N31.jpg">' +
					'</div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-5F3zm1.jpg">' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<div style="padding-right:30px">' +
							_tabs(1) + '<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-4r9Fa1.jpg">' +
						'\n</div>' +
					'</div>' +
					'<div class="column half">' +
						'<div class="spacer height-80"></div>' +
				...
				'<div class="row clearfix">' +
					...
					'<div class="column half">' +
						'<div style="padding-left:30px">' +
							_tabs(1) + '<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-lbizY1.jpg">' +
						'\n</div>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-ocaLR1.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="spacer height-40"></div>' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-mHAa32.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column two-third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-OJKzv1.jpg">' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column two-third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-I81sR1.jpg">' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/bangkit-ristant-395541-e0mhz1.jpg" style="border-radius: 500px;">' +
						'\n<h3 class="size-21" style="letter-spacing: 2px;">VINCENT NELSON</h3>' +
						'\n<p style="color: #b7b7b7">WEB DESIGNER</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/redd-angelo-427759-33bDf2.jpg" style="border-radius: 500px;">' +
						'\n<h3 class="size-21" style="letter-spacing: 2px;">NATHAN WILLIAMS</h3>' +
						'\n<p style="color: #b7b7b7">WEB DEVELOPER</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/mads-schmidt-rasmussen-186319-8AVbA1.jpg" style="border-radius: 500px;">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/samuel-zeller-413072-Tx4ai1.jpg">' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/michael-236683-Tx4ai2.jpg">' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/michael-221247-Hspxi3.jpg">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/working-2618559_1920-kr4Af1.jpg">' +
						'\n<h5 style="letter-spacing: 3px;">Sarah Doe</h5>' +
						'\n<p style="color: rgb(136, 136, 136);">Founder</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/rawpixel-632454-unsplash-ecHZN1.jpg">' +
						'\n<h5 style="letter-spacing: 3px;">David Anderson</h5>' +
						'\n<p style="color: rgb(136, 136, 136);">Programmer</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/girl-2618562_1920-KAzoZ2.jpg">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/luke-ellis-craven-365822-wrHAg1.jpg">' +
						'\n<h5 class="size-24" style="letter-spacing: 2px;">Nathan Williams <span style="color: rgb(136, 136, 136);">/ Founder</span></h5>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>' +
					'</div>' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/yoann-boyer-276971-S8TZu2.jpg">' +
						'\n<h5 class="size-24" style="letter-spacing: 2px;">Sarah Anderson <span style="color: rgb(136, 136, 136);">/ Developer</span></h5>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>' +
					'</div>' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/pablo-hermoso-429590-(1)-fP4pI3.jpg">' +
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/adult-1868750_1920-EzivE1.jpg" style="border-radius: 500px;">' +
						'\n<h3 class="size-24">David Smith</h3>' +
						'\n<p style="color: rgb(136, 136, 136);;">CEO & Founder</p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/noah-buscher-502067-(1)-rT7Vn1.jpg" style="border-radius: 500px;">' +
						'\n<h3 class="size-24">Milla Clarke</h3>' +
						'\n<p style="color: rgb(136, 136, 136);;">Project Manager</p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/berwin-coroza-495276-tXRrf2.jpg" style="border-radius: 500px;">' +
						'\n<h3 class="size-24">John Rugg</h3>' +
						'\n<p style="color: rgb(136, 136, 136);;">Developer</p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/mark-skeet-537093-6gF113.jpg" style="border-radius: 500px;">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/girl-690119-c7s4t1.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<h2>Your Name</h2>' +
						'\n<p>Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/photo-1437915160026-6c59da36ede2-AakHA2.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<h2>Your Name</h2>' +
						'\n<p>Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<div class="is-card max-390 is-light-text" style="background: #1c93ad;">' +
							_tabs(1) + '<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/bernard-osei-608155-unsplash-BsEPC1.jpg" class="margin-0">' +
					...
					'<div class="column third">' +
						'<div class="is-card max-390 is-light-text" style="background: #e0527e;">' +
							_tabs(1) + '<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-HAWqm1.jpg" class="margin-0">' +
							_tabs(1) + '<div class="margin-25 center">' +
					...
					'<div class="column third">' +
						'<div class="is-card max-390 is-light-text" style="background: #e17055">' +
							_tabs(1) + '<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/girl-from-behind-1741699-(1)-PqduN2.jpg" class="margin-0">' +
							_tabs(1) + '<div class="margin-25 center">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/rawpixel-632454-unsplash-oLoHS1.jpg" style="border-radius: 500px;">' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-tfqUv1.jpg" style="border-radius: 500px;">' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/rawpixel-1054600-unsplash-PylVl2.jpg" style="border-radius: 500px;">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/sarah-noltner-687653-unsplash-6Agfw1.jpg">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/luke-porter-520986-unsplash-kjuDr1.jpg" style="border-radius: 500px;">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/nicole-honeywill-546846-unsplash-(1)-84PNj2.jpg" style="border-radius: 500px;">' +
					'</div>' +
					'<div class="column half">' +
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/alex-iby-480498-unsplash-JOL3q3.jpg" style="border-radius: 500px;">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/nordwood-themes-166423-unsplash-(1)-4WJ2H1.jpg">' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-9Htn91.jpg">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/parker-johnson-1100877-unsplash-(1)-rufBy1.jpg">' +
					'</div>' +
					'<div class="column half">' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/beautiful-close-up-color-1078058-Qywhs1.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/daniel-apodaca-584113-unsplash-(1)-U9Iby1.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/alex-shaw-1116446-unsplash-JWfd61.jpg" style="border-radius: 500px;">' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-JMXQP1.jpg" style="border-radius: 500px;">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/simon-migaj-775713-unsplash-l8oSx1.jpg" style="border-radius: 500px;">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-6Q6W91.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="spacer height-80"></div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-ayzzH2.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-fxBmr1.jpg">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-6SDpQ1.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-z01lr1.jpg">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-SRJrq2.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-otLsK1.jpg">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-TUrpQ1.jpg">' +
					'</div>' +
				'</div>'
		},

        {
            ...
            'html':
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-DbQGW1.jpg" style="border-radius: 500px">' +
					'</div>' +
					'<div class="column two-third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-gs7XT1.jpg">' +
					'</div>' +
					'<div class="column two-third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-DjWQ71.jpg" style="border-radius: 500px;">' +
					'</div>' +
					'<div class="column half">' +
						'<div style="padding-left:40px">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-c2y4f1.jpg" style="border-radius: 500px;">' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/photo-1459411552884-841db9b3cc2a-YO89Y1.jpg">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/photo-1471256737566-c7ddd846bee0-small-NBNfZ2.jpg">' +
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<div class="is-card is-dark-text shadow-1">' +
							_tabs(1) + '<div class="margin-25">' +
								_tabs(2) + '<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/x98sw2520-sh1J31.jpg" style="border-radius: 500px">' +
					...
					'<div class="column third center">' +
						'<div class="is-card is-dark-text shadow-1">' +
							_tabs(1) + '<div class="margin-25">' +
								_tabs(2) + '<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/georgie-cobbs-467923-unsplash-G9q9p2.jpg" style="border-radius: 500px">' +
					...
					'<div class="column third center">' +
						'<div class="is-card is-dark-text shadow-1">' +
							_tabs(1) + '<div class="margin-25">' +
								_tabs(2) + '<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/martin-widenka-555176-unsplash-sh1J33.jpg" style="border-radius: 500px">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-7eFyL1.jpg">' +
						'\n<h3 class="size-21">PRODUCT NAME</h3>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n<p><a href="#">BUY NOW</a></p>' +
					'</div>' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-09yZA2.jpg">' +
						'\n<h3 class="size-21">PRODUCT NAME</h3>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n<p><a href="#">BUY NOW</a></p>' +
					'</div>' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-Tmg8p2.jpg">' +
						'\n<h3 class="size-21">PRODUCT NAME</h3>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n<p><a href="#">BUY NOW</a></p>' +
					'</div>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/h-e-n-g-s-t-r-e-a-m-573432-unsplash-xt89A1.jpg" alt="">' +
					...
					'</div>' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/sarah-dorweiler-357724-unsplash-4cfGV2.jpg" alt="">' +
						'\n<h3 class="size-24" style="font-weight: 400;">PRODUCT NAME, <span style="color: rgb(136, 136, 136);">$79</span></h3>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>' +
						'\n<p><a href="#" title="">BUY NOW</a></p>' +
					'</div>' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/michael-frattaroli-234662-unsplash-QaduA1.jpg" alt="">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-5v3uL1.jpg">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-C3XHH1.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<div style="padding-left: 40px">' +
							_tabs(1) + '<h1 class="size-42">Product Name</h1>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-7Vn0R1.jpg">' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/nordwood-themes-473050-jFvLM1.jpg">' +
						'\n<p style="color: rgb(136, 136, 136); font-weight: normal;">' +
							_tabs(1) + 'PRODUCT NAME' +
							_tabs(1) + '<br>' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/toa-heftiba-448302-(1)-pXDhf1.jpg">' +
						'\n<p style="color: rgb(136, 136, 136); font-weight: normal;">' +
							_tabs(1) + 'PRODUCT NAME' +
							_tabs(1) + '<br>' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-p8OMT2.jpg">' +
						'\n<p style="color: rgb(136, 136, 136); font-weight: normal;">' +
							_tabs(1) + 'PRODUCT NAME' +
							_tabs(1) + '<br>' +
							_tabs(1) + '<a href="#" title="">$99</a>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/imac-Bz83W1.png">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="list">' +
							_tabs(1) + '<i class="icon ion-checkmark"></i>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/kara-michelle-544960-zjkQn1.jpg">' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/aidan-hancock-440776-unsplash-8u7fo1.jpg">' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/workplace-1245776_1280-oxBIU1.jpg">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/desk-office-hero-workspace-(1)-V8F292.jpg">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-BwYjC1.jpg"></div>' +
					'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
						'<div class="spacer height-40"></div>' +
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-FrSUb2.jpg">' +
					'</div>' +
					'<div class="column half">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third">' +
						'<div style="padding-right:30px">' +
							_tabs(1) + '<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-sGkY41.jpg">' +
						'\n</div>' +
					'</div>' +
					'<div class="column third">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-UPno91.jpg">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-lkx4s2.jpg">' +
					'</div>' +
					'<div class="column half">' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-sJf643.jpg">' +
					'</div>' +
				'</div>'
		},
...

        {
            ...
            'html':
		    	...
		    	'<div class="row clearfix">' +
		    		'<div class="column half center">' +
		    			'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-F0dm51.jpg">' +
					...
					'</div>' +
					'<div class="column half center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-x5GRp1.jpg">' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-S0R1k1.jpg">' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry. — Nelson Sand</p>' +
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-QqxYJ2.jpg">' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column third center">' +
		    			'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-F6TCZ1.jpg">' +
		    		'</div>' +
		    		'<div class="column two-third">' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column third center">' +
		    			'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-Q1XSO1.jpg" style="border-radius: 500px">' +
		    		'</div>' +
		    		'<div class="column two-third">' +
		    			'<div style="margin-top:10px"><i class="icon ion-quote size-24" style="color: #888888"></i></div>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>' +
...

		{
		    ...
		    'html':
		    	...
		    	'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-akB4h1.jpg">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="quote">' +
							_tabs(1) + '<i class="icon ion-quote"></i>' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-R79NY2.jpg">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
		    	...
		    	'<div class="row clearfix">' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-ybeSl1.jpg" style="border-radius: 500px;">' +
					'</div>' +
					'<div class="column half">' +
						'<div class="quote">' +
							_tabs(1) + '<i class="icon ion-quote"></i>' +
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-KUCDN4.jpg" style="border-radius: 500px;">' +
					'</div>' +
				'</div>'
		},
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/watch-1663246_1920-8wuCM1.jpg">' +
						'\n<div class="spacer height-20"></div>' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-frUlS1.jpg">' +
						'\n<div class="spacer height-20"></div>' +
						'\n<i class="icon ion-quote size-24"></i>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n<p class="size-14">by Your Name</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-RXypm2.jpg">' +
						'\n<div class="spacer height-20"></div>' +
						'\n<i class="icon ion-quote size-24"></i>' +
						'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
						'\n<p class="size-14">by Your Name</p>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/noah-buscher-548633-ExLNF1.jpg" style="border-radius: 500px;">' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/icons8-team-355990-Voloz1.jpg" style="border-radius: 500px;">' +
						'\n<p style="color: #bdc3c7"><i class="icon ion-android-hangout size-32"></i></p>' +
						'\n<p class="size-16">Lorem Ipsum is simply dummy text of the printing industry. — Clara Wang</p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/pexels-photo-girl-zZWwv1.jpg" style="border-radius: 500px;">' +
						'\n<p style="color: #bdc3c7"><i class="icon ion-android-hangout size-32"></i></p>' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column half">' +
		    			'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-6PDKL1.jpg">' +
		    		'</div>' +
		    		'<div class="column half">' +
...

		{
		    ...
		    'html':
		    	'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column half">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-OWu2H1.jpg">' +
					'</div>' +
				'</div>'
		},
		    ...
		    'html':
		    	'<div class="row clearfix">' +
		    		'<div class="column center full">' +
		    			'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-TK4An1.jpg" style="border-radius: 500px">' +
		    		'</div>' +
		    	'</div>' +
		    	'<div class="row clearfix">' +
		    		'<div class="column center full">' +
...

		{
			...
			'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/creative.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/light-studio.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/infinitech.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/design-firm.png">' +
					'</div>' +
				'</div>'
		},
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<div class="center" style="display:inline-block;width:18%">' +
							'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/sitepro.png">' +
						'</div>' +
						'<div class="center" style="display:inline-block;width:18%">' +
							'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/steady.png">' +
						'</div>' +
						'<div class="center" style="display:inline-block;width:18%">' +
							'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/creative.png">' +
						'</div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/onesight.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/mmedia.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/digitalmag.png">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column fourth">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/upclick.png">' +
					'</div>' +
					'<div class="column fourth">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/onesight.png">' +
					'</div>' +
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column third center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/worldwide.png">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/bbuzz.png">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/prosource.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/light-studio.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/nett.png">' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/worldwide.png">' +
					'</div>' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/lost-2747289-ThbrT1.png">' +
...

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<img src="/admin_assets/plugins/ContentBuilder/assets/minimalist-blocks/images/-5TpV91.jpg">' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full center">' +
